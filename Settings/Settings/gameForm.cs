...
namespace Settings
{
    public partial class gameForm : Form
    {
        ...
        public gameForm()
        {
            ...
            SendMessage(txtProfile.Handle, EM_SETCUEBANNER, 0, "https://steamcommunity.com/id/rasasport4");
            SendMessage(txtSearch.Handle, EM_SETCUEBANNER, 0, "Найти игры");
        ...
        private void lvlExampleInput_Click(object sender, EventArgs e)
        {
            MessageBox.Show(
                "Полный URL\n"
                + "• https://steamcommunity.com/id/rasasport4\n"
                + "• http://steamcommunity.com/profiles/543856374592367\n\n"
                + "Кастомный URL или SteamID\n"
                + "• 793485209580340\n"
                + "• rasasport4",
                "Образец ввода");
        }
        ...
        private void txtProfile_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("Введенное значение профиля недействительно", "Давай нормально вводи");
                }
            }
        }
        ...
        private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            gameGroup.Text = $"Игр: {mGames.Count}";
        ...
        private void gameGroup_Enter(object sender, EventArgs e)
        {
