...
namespace Settings
{
    public partial class mainForm : Form
    {
        ...
        private void mainForm_Load(object sender, EventArgs e)
        {
            ...
            if (procs.Length > 0)
            {
                MessageBox.Show("Настройки будут перезаписаны при закрытии HourBoostr..\n"
                    + "Я бы не рекомендовал вносить здесь какие-либо изменения во время работы HourBoostr..\n"
                    + "Если вам нужно внести какие-либо изменения, сделайте копию Settings.json.", "Осторожно!");
            }
            ...
            if (File.Exists(file))
            {
                ...
                {
                    MessageBox.Show($"Невозможно прочитать Settings.json\n\n{ex.Message}", "Чекни Settings.json!");
                }
            }
        ...
        private void SaveAccountJson()
        {
            ...
            {
                MessageBox.Show($"Не удается прочитать Settings.json.\n\n{ex.Message}", "Да да");
            }
        }
        ...
        private void txtUsername_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Этот аккаунт уже добавлен в список.", "Слушай.");
        ...
        private void removeAccountToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                diagResult = MessageBox.Show($"Ты '{mActiveAccount.Details.Username}'?",
        ...
        private void lblStartBooster_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Аккаунт не добавлен", "Ошибка");
                return;
            }
            ...
            {
                MessageBox.Show("Не удалось найти HourBoostr.exe", "Вот это да...");
            }
        }
        ...
        private void cbRestartGames_CheckedChanged(object sender, EventArgs e)
        {
